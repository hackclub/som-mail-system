...
import { getRecordById } from '../api/leap/[record_id]';
import { setRecipientScan } from '../api/leap/[record_id]/recipient-scan'
...
function RecipientScanPage(props) {
  ...
  const uploadPhotos = async (e, record_id) => {
    ...
    const updatedRecord = await fetch(`/api/leap/${record_id}/recipient-upload?image_url=${tempFileUrl}`)
